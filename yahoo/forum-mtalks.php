<?php
  ...
  include_once(dirname(__FILE__) . "/Yahoo_UGC_Forum.class.php");
	...
	$rows = array();
	$urls = get_url_list("http://verywed.com/forum/mtalks/list/{page}.html", "td.subject a[href$=-1.html]", $page_first, $page_limit);
  ...
  echo "Result: " . Yahoo_UGC_Forum::buildXML("tw_verywed_" . date("Ymd_His") . "_7", $rows) . "\n";
?>
