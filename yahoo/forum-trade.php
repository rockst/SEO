<?php
	...
	$rows = array();
	$urls = get_url_list("http://verywed.com/forum/trade/list/{page}.html", "td.subject a[href$=-1.html]", $page_first, $page_limit);
  ...
  echo "Result: " . Yahoo_UGC_Forum::buildXML("tw_verywed_" . date("Ymd_His") . "_5", $rows) . "\n";
?>
